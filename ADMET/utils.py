...
TASKS = {
    "caco2_wang": {
        ...
        "use_log_scale": False,
        "label_list": False,
        "description": "Epithelial tissue permeation"
    },
    "hia_hou": {
    ...
    "pgp_broccatelli": {
        ...
        "use_log_scale": False,
        "label_list": False,
        "description": "Pgp protein involved in intestinal absorption, drug metabolism and BBB penetraion"
    },
    "bioavailability_ma": {
        "task_type": "binary_classification",
        "use_log_scale": False,
        "label_list": False,
        "description": "Orally bioavailable"
    ...
    "bbb_martins": {
        ...
        "use_log_scale": False,
        "label_list": False,
        "description":"Able to permeate blood brain barrier"
    },
    "ppbr_az": {
        "task_type": "regression",
        "use_log_scale": True,
    ...
    "cyp2c19_veith": {
        ...
        "use_log_scale": False,
        "label_list": False,
        "description": "inhibition of this enzyme, which breaks down many drugs and molecules"
    },
    "cyp2d6_veith": {
        "task_type": "binary_classification",
        "use_log_scale": False,
        "label_list": False,
        "desc": "inhibition of this enzyme responsible for endoplasmic reticulum formation"
    },
    "cyp3a4_veith": {
        "task_type": "binary_classification",
        "use_log_scale": False,
    ...
    "dili": {
        ...
        "use_log_scale": False,
        "label_list": False,
        "desc":"drug induced liver injury"
    },
    "skin reaction": {
        "task_type": "binary_classification",
        "use_log_scale": False,
    ...
    "clintox": {
        ...
        "use_log_scale": False,
        "label_list": False,
        "desc":"clinical toxicity (clinical trials data)"
    },
    'ld50_zhu':{
        "task_type": "regression",
        "use_log_scale": False,
